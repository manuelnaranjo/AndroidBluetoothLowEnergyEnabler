...
public class RemoveProcess extends Thread {
    ...
    public void run() {
        ...
        for (String t: Arrays.asList("/system/lib/libbt-hci.so", 
        ...
        ret = sendCommand("rm -f /system/etc/permissions/android.hardware.bluetooth_le.xml");
        mListener.logInfo("Removed permission file " + (ret ? "correctly" : "failure"));
